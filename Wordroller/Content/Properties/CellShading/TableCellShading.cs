...
{
	public class TableCellShading : OptionalXmlElementWrapper
	{
		private readonly ITableCellShadingContainer container;

		internal TableCellShading(ITableCellShadingContainer container, XElement? xml) : base(xml)
		{
		...
		{
			return container.GetOrCreateCellShadingXmlElement();
		}
	}
}