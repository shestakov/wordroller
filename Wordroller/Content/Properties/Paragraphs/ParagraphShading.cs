...
{
	public class ParagraphShading : OptionalXmlElementWrapper
	{
		private readonly IParagraphShadingContainer container;

		internal ParagraphShading(IParagraphShadingContainer container, XElement? xml) : base(xml)
		{
